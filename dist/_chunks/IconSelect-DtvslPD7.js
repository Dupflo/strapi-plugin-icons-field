...
const index = require("./index-DHhe-BEa.js");
...
const IconSelect = (props) => {
  ...
  const handleChange = (icon) => {
    const storedValue = outputFormat === "name" ? icon.name.toLowerCase() : icon.svg;
  ...
  const selectedIconData = React.useMemo(() => {
    ...
    if (outputFormat === "name") {
      return allIcons.find((icon) => icon.name.toLowerCase() === value);
    }
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Modal.Body, { children: [
              ...
              filteredIcons.map((group) => /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, { marginBottom: 6, children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, { display: "flex", marginTop: 2, style: { flexWrap: "wrap", gap: 6 }, children: group.icons.map((icon) => {
                  const isSelected = outputFormat === "name" ? value === icon.name.toLowerCase() : value === icon.svg;
                  return /* @__PURE__ */ jsxRuntime.jsxs(
                    designSystem.Box,
                    {
                      ...
                      children: [
                        ...
                        attribute?.options?.showIconLabel && /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral800", style: { marginTop: 8, textTransform: "none" }, children: icon.name })
                      ]
                    },
                    icon.name
                  );
...
//# sourceMappingURL=IconSelect-DtvslPD7.js.map
