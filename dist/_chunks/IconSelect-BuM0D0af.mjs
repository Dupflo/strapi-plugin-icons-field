...
import { Field, Modal, Box, Button, Typography, TextInput } from "@strapi/design-system";
import { useFetchClient } from "@strapi/strapi/admin";
import { P as PLUGIN_ID } from "./index-DPmL-Z_b.mjs";
import parse from "html-react-parser";
import { useTheme } from "styled-components";
import { CaretDown, Cross, Search } from "@strapi/icons";
                      ...
                      "div",
                      {
                        ...
                        children: [
                          selectedIconData ? /* @__PURE__ */ jsxs(Fragment, { children: [
                            /* @__PURE__ */ jsx(Icon, { icon: selectedIconData.svg, style: { height: "24px", display: "block" } }),
            ...
            /* @__PURE__ */ jsxs(Modal.Body, { children: [
              /* @__PURE__ */ jsx(Box, { marginBottom: 4, children: /* @__PURE__ */ jsx(
                TextInput,
                {
                  ...
                  startAction: /* @__PURE__ */ jsx(Search, { style: { height: "16px", width: "16px" } })
                }
              ) }),
                  ...
                  return /* @__PURE__ */ jsxs(
                    Box,
                    {
                      ...
                      style: {
                        ...
                        aspectRatio: "1/1",
                        background: "white",
                        border: isSelected ? `2px solid ${theme.colors?.primary600}` : "1px solid #ccc",
                        borderRadius: "4px",
                        cursor: "pointer",
                        display: "flex",
                      ...
                      children: [
                        ...
                        attribute?.options?.showIconLabel && /* @__PURE__ */ jsx(Typography, { variant: "pi", fontWeight: "bold", style: { marginTop: 8 }, children: icon.name })
                      ]
                    },
                    icon.name
                  );
...
//# sourceMappingURL=IconSelect-BuM0D0af.mjs.map
