...
const index = {
  register(app) {
    app.customFields.register({
      ...
      components: {
        Input: async () => Promise.resolve().then(() => require("./IconSelect-BgjkDVGW.js"))
      },
      options: {
        base: [
          {
  ...
  async registerTrads({ locales }) {
    return Promise.all(
      locales.map(async (locale) => {
        try {
          const { default: data } = await __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "./translations/en.json": () => Promise.resolve().then(() => require("./en-v5566hIn.js")), "./translations/fr.json": () => Promise.resolve().then(() => require("./fr-xGzjcs0y.js")) }), `./translations/${locale}.json`, 3);
          return { data, locale };
        } catch {
          return { data: {}, locale };
        }
...
exports.index = index;
//# sourceMappingURL=index-CL21voMF.js.map
