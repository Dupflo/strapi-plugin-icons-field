...
import { P as PLUGIN_ID } from "./index-BDmC42Vp.mjs";
                  ...
                  return /* @__PURE__ */ jsxs(
                    Box,
                    {
                      ...
                      children: [
                        ...
                        attribute?.options?.showIconLabel && /* @__PURE__ */ jsx(Typography, { variant: "pi", fontWeight: "bold", textColor: "neutral800", style: { marginTop: 8, textTransform: "none" }, children: icon.name })
                      ]
                    },
                    icon.name
                  );
...
//# sourceMappingURL=IconSelect-Bta6Zfs-.mjs.map
